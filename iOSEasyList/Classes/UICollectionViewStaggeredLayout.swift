...
@objc public protocol UICollectionViewDelegateStaggeredLayout: UICollectionViewDelegate {
    ...
    @objc optional func collectionView (_ collectionView: UICollectionView, layout staggeredCollectionViewLayout: UICollectionViewStaggeredLayout,
...
public enum UICollectionViewStaggeredLayoutItemRenderDirection: Int {
    case shortestFirst
    case leftToRight
    case rightToLeft
}

public  let StaggeredCollectionElementKindSectionHeader = "StaggeredCollectionElementKindSectionHeader"
public  let StaggeredCollectionElementKindSectionFooter = "StaggeredCollectionElementKindSectionFooter"
public class UICollectionViewStaggeredLayout: UICollectionViewLayout {
    ...
    public var itemRenderDirection: UICollectionViewStaggeredLayoutItemRenderDirection {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public weak var delegate: UICollectionViewDelegateStaggeredLayout? {
        get {
            return self.collectionView!.delegate as? UICollectionViewDelegateStaggeredLayout
        }
    }
    ...
    override public init() {
        ...
        self.itemRenderDirection =
            UICollectionViewStaggeredLayoutItemRenderDirection.shortestFirst
    ...
    override public func prepare() {
        ...
        for section in 0 ..< numberOfSections {
            ...
            if heightHeader > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: StaggeredCollectionElementKindSectionHeader, with: IndexPath(row: 0, section: section))
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: StaggeredCollectionElementKindSectionFooter, with: IndexPath(item: 0, section: section))
    ...
    override public func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes {
        ...
        if elementKind == StaggeredCollectionElementKindSectionHeader {
            attribute = self.headersAttributes[indexPath.section]
        } else if elementKind == StaggeredCollectionElementKindSectionFooter {
